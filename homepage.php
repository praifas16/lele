...
<head>
    ...
    <style>
        ...
        .secondary-nav a {
            display: inline-block;
            padding: 15px 30px;
            background-color: #808080; /* สีเทาๆ */
            color: #FFF;
            text-decoration: none;
            transition: background-color 0.3s ease;
        }
        ...
        .secondary-nav a:nth-child(2) {
            background-color: #2c3e50; /* เปลี่ยนสีตามที่คุณต้องการ */
        }
        ...
        .image-container img {
            ...
            max-width: 100%; /* ปรับขนาดสูงสุดให้ภาพไม่ขยายเกินขนาดต้นฉบับ */
            max-height: 300px; /* ปรับความสูงสูงสุดของภาพ */
            margin-right: 10px;
